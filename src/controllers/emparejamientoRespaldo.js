    ...
    try {
        ...
        class Grafica {
            ...
            reordenarSiMismoGimnasio() {
                ...
                // Si hay dos competidores del mismo gimnasio, los coloca en posiciones 0 y 3
                for (let gym in gymCounts) {
                    if (gymCounts[gym] > 1) {
                        let positions = [];
                        this.competidores.forEach((comp, index) => {
                            if (comp && comp.gimnasio === gym) {
                                positions.push(index);
                            }
                        });
        
                        if (positions.length > 1) {
                            [this.competidores[positions[0]], this.competidores[0]] = [this.competidores[0], this.competidores[positions[0]]];
                            [this.competidores[positions[1]], this.competidores[3]] = [this.competidores[3], this.competidores[positions[1]]];
                        }
                    }
                }
            }
